...
interface DependencyInjector {
    ...
    fun bind(dependencyClassToDependencyProviderPair: Pair<KClass<*>, DependencyProvider<out Any>>) =
        bind(dependencyClassToDependencyProviderPair.first, dependencyClassToDependencyProviderPair.second)

    fun bind(dependencyClass: KClass<*>, dependencyProvider: DependencyProvider<out Any>)
    ...
    fun <T : Any> create(dependencyClass: KClass<T>): T =
        createOrNull(dependencyClass) ?: error("Could not create dependency consumer '${dependencyClass.simpleName}'")
}