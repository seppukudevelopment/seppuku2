...
abstract class AbstractDependencyInjector(
    ...
    final override fun bind(dependencyClass: KClass<*>, dependencyProvider: DependencyProvider<out Any>) {
    ...
    final override fun <T : Any> getOrNull(dependencyClass: KClass<T>): T? =
        DependencyResolver.resolveDependency(
            dependencyClass.starProjectedType.classifier,
            dependencyClassToDependencyProviderMap
        ) as? T

    final override fun <T : Any> createOrNull(dependencyClass: KClass<T>): T? =
        DependencyResolver.createBySuitableConstructor(dependencyClass, dependencyClassToDependencyProviderMap)
}