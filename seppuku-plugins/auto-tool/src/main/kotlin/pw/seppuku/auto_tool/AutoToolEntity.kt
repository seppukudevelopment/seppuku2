...
abstract class AutoToolEntity(
    ...
    @Component
    val clientPlayerInteractionManagerAttackBlock = ClientPlayerInteractionManagerAttackBlock { blockPos, _ ->
    ...
    private fun BlockState.getSlotRating(index: Int): Float =
        this@AutoToolEntity.minecraftClient.player?.inventory?.getStack(index)?.getMiningSpeedMultiplier(this) ?: 0f
